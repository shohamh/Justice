...
`dev` is this repo's integration branch (see AGENTS.md's Branch workflow).
...
AGENTS.md) — it's part of the release step itself, not a bypass of it.
...
- See AGENTS.md's "Branch workflow" and "Changelog" sections for the policy this skill implements.
