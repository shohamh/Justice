        ...
        <div className="fixed inset-0 bg-black/30 flex items-center justify-center z-50" onClick={() => setExemptTarget(null)}>
          <div className="bg-white rounded-lg shadow-xl p-6 w-full max-w-md" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="space-y-3">
              ...
              <select className="w-full border rounded p-2" value={exemptionTypeId} onChange={(e) => setExemptionTypeId(e.target.value)}>
              ...
              <input type="date" className="w-full border rounded p-2" value={exemptStart} onChange={(e) => setExemptStart(e.target.value)} />
              <label className="block text-sm">{t("command_dashboard.exemption_end")}</label>
              <input type="date" className="w-full border rounded p-2" value={exemptEnd} onChange={(e) => setExemptEnd(e.target.value)} />
