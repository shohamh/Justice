...
```bash
grep -n "client_factory\|make_client" /c/Users/Shoham/workspace/callofduty2/backend/tests/conftest.py | head -10
```
...
```bash
head -40 /c/Users/Shoham/workspace/callofduty2/backend/tests/integration/test_reserves_api.py 2>/dev/null || \
head -40 /c/Users/Shoham/workspace/callofduty2/backend/tests/integration/test_calendar_api.py
```
...
```bash
grep -rn "HelpModal" /c/Users/Shoham/workspace/callofduty2/frontend/src/ | grep -v ".d.ts"
```
...
```bash
cd /c/Users/Shoham/workspace/callofduty2 && docker compose up -d db
cd backend && uv run alembic upgrade head
...
```bash
cd /c/Users/Shoham/workspace/callofduty2/backend && uv run pytest tests/unit/test_gimelim_service.py tests/integration/test_gimelim_api.py -v
```
