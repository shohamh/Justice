...
export default function RangesPage() {
  ...
  const count = (e: RangeEvent, reserve: boolean) => e.assignments.filter(a => a.is_reserve === reserve && !a.is_draft).length;
  const rows = useMemo(() => {
