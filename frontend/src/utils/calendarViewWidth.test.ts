...
describe("calendarViewMinWidth", () => {
  ...
  it("computes 7 columns * 140px + 60px gutter for the week view", () => {
    expect(calendarViewMinWidth("timeGridWeek")).toBe(1040);
  });

  it("computes 3 columns * 140px + 60px gutter for the 3-day view", () => {
    expect(calendarViewMinWidth("timeGridThreeDay")).toBe(480);
  });
});
