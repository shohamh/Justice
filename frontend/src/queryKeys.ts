...
export const queryKeys = {
  ...
  myHierarchyTransfers: () => ["hierarchyTransfers", "mine"] as const,
  myEnrollment: () => ["enrollment", "mine"] as const,
  myRangeExcusalRequests: () => ["rangeExcusalRequests", "mine"] as const,
  requestsUnseenCount: () => ["requests", "unseenCount"] as const,
