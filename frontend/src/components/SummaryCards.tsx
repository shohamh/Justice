...
export default function SummaryCards({ data, onCardClick }: Props) {
  ...
  return (
    <div className="flex gap-4 mb-6" data-testid="summary-cards">
      <button onClick={() => onCardClick("approvals")} className="flex-1 bg-white dark:bg-gray-800 rounded-lg shadow p-4 text-right hover:bg-gray-50 dark:hover:bg-gray-700" data-testid="card-approvals">
      ...
      <button onClick={() => onCardClick("upcoming")} className="flex-1 bg-white dark:bg-gray-800 rounded-lg shadow p-4 text-right hover:bg-gray-50 dark:hover:bg-gray-700" data-testid="card-upcoming">
      ...
      <button onClick={() => onCardClick("alerts")} className="flex-1 bg-white dark:bg-gray-800 rounded-lg shadow p-4 text-right hover:bg-gray-50 dark:hover:bg-gray-700" data-testid="card-alerts">
