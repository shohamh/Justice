...
interface Props { rows: RangeEvent[]; onRowClick:(event:RangeEvent)=>void; rowActions:(event:RangeEvent)=>ReactNode; filters?:ReactNode; sort?:ReactNode; loading?: boolean; error?: ReactNode; }
