    ...
    <div className="space-y-4 text-sm leading-relaxed" dir="rtl">
      ...
      <div className="space-y-3">
        <div className="bg-blue-50 rounded-lg p-3 border border-blue-200">
          <p className="font-medium text-blue-800 mb-1">📌 בקשה פתוחה</p>
          <p className="text-blue-700">לא יודעים מי יחליף? כל חייל ביחידה יכול לראות את הבקשה ולהציע עצמו.</p>
        </div>
        <div className="bg-purple-50 rounded-lg p-3 border border-purple-200">
          <p className="font-medium text-purple-800 mb-1">📌 בקשה ממוקדת</p>
          <p className="text-purple-700">יש מישהו ספציפי? ציינו אותו — הוא יקבל התראה ויאשר או ידחה.</p>
        </div>
        <div className="bg-amber-50 rounded-lg p-3 border border-amber-200">
          <p className="font-medium text-amber-800 mb-1">⚠️ חשוב לדעת</p>
  ...
  return (
    <div className="space-y-4 text-sm leading-relaxed" dir="rtl">
      ...
      <div className="space-y-2">
        <p className="font-medium text-gray-800">🔎 מה האלגוריתם לוקח בחשבון?</p>
        {[
...
function FairnessTab() {
  return (
    <div className="space-y-4 text-sm leading-relaxed" dir="rtl">
      ...
      <div className="bg-indigo-50 rounded-xl p-4 border border-indigo-200 space-y-3">
        <p className="font-semibold text-indigo-800">📊 מהו ניקוד מנורמל?</p>
      ...
      <div className="bg-amber-50 rounded-xl p-4 border border-amber-200 space-y-2">
        <p className="font-semibold text-amber-800">🚩 מתי לפנות למפקד?</p>
      ...
      <div className="bg-gray-50 rounded-lg p-3 border border-gray-200">
        <p className="font-medium text-gray-700 mb-1">🔍 איפה לבדוק?</p>
...
export default function HelpModal({ onClose }: Props) {
  ...
  return (
    ...
    >
      ...
      >
        {/* Header */}
        <div className="flex items-center justify-between px-5 pt-5 pb-3 border-b" dir="rtl">
          <h2 className="text-lg font-bold text-gray-900">מדריך המערכת</h2>
          <button
            onClick={onClose}
        ...
        {/* Tabs */}
        <div className="flex border-b px-2 pt-1" dir="rtl">
          {TABS.map((tab) => (
            <button
              key={tab.id}
